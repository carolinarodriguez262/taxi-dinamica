    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartnerServices", x => new { x.PartnerId, x.ServiceId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Appointments_PartnerServices_PartnerId_ServiceId",
                        columns: x => new { x.PartnerId, x.ServiceId },
                        principalTable: "PartnerServices",
                        principalColumns: new[] { "PartnerId", "ServiceId" },
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_PartnerId_ServiceId",
                table: "Appointments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PartnerServices_IsDeleted",
